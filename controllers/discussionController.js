...
exports.createPost = (req, res, next) => {
    ...
    let timestamp = req.body.timestamp;//not sure how this would be passed yet
    ...
    await messagePostData.addMessagePost(data)
    .then(() =>{ 
...
exports.getAllPosts = (req, res, next) => {
    ...
    messagePostData.getMessagePost(userid)
    .then(data => {
...
exports.addComment = (req, res, next) => {
    ...
    replyData.addReplyPost(replydetail, timestamp, userid, postid)
    .then(data => {
        console.log("success adding reply", data);
    }).catch(err => {
        console.log("Error adding reply", err);
